...
type OrganizationsConfig struct {
	...
	Spec   OrganizationsConfigSpec   `json:"spec,omitempty"`
	Status OrganizationsConfigStatus `json:"status,omitempty"`
}

type OrganizationsConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []OrganizationsConfig `json:"items"`
}

type OrganizationsConfigSpec struct {
	Mandatory cascade.OrganizationsConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.OrganizationsConfigSection `json:"defaults,omitempty"`
}

type OrganizationsConfigStatus struct {
	EffectiveConfig    EffectiveOrganizationsConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveOrganizationsConfig struct {
	...
	Mandatory cascade.EffectiveOrganizationsSection    `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveOrganizationsSection    `json:"defaults,omitempty"`
}

func (in *OrganizationsConfig) DeepCopyInto(out *OrganizationsConfig) {
	*out = *in
...
func (in *OrganizationsConfig) DeepCopy() *OrganizationsConfig {
	if in == nil {
		return nil
	}
	out := new(OrganizationsConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *OrganizationsConfig) DeepCopyObject() runtime.Object {
...
func (in *OrganizationsConfigList) DeepCopyInto(out *OrganizationsConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]OrganizationsConfig, len(in.Items))
...
func (in *OrganizationsConfigList) DeepCopy() *OrganizationsConfigList {
	if in == nil {
		return nil
	}
	out := new(OrganizationsConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *OrganizationsConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s OrganizationsConfigStatus) MarshalJSON() ([]byte, error) {
