...
type RecycleBinConfig struct {
	...
	Spec   RecycleBinConfigSpec   `json:"spec,omitempty"`
	Status RecycleBinConfigStatus `json:"status,omitempty"`
}

type RecycleBinConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []RecycleBinConfig `json:"items"`
}

type RecycleBinConfigSpec struct {
	Mandatory cascade.EBSRecycleBinConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.EBSRecycleBinConfigSection `json:"defaults,omitempty"`
}

type RecycleBinConfigStatus struct {
	EffectiveConfig    EffectiveRecycleBinConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition        `json:"conditions,omitempty"`
	ObservedGeneration int64                     `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                    `json:"syncedTimestamp,omitempty"`
}

type EffectiveRecycleBinConfig struct {
	AWS       ProviderIdentity                       `json:"aws,omitempty"`
	Mandatory cascade.EffectiveEBSRecycleBinSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveEBSRecycleBinSection `json:"defaults,omitempty"`
}

func (in *RecycleBinConfig) DeepCopyInto(out *RecycleBinConfig) {
	*out = *in
...
func (in *RecycleBinConfig) DeepCopy() *RecycleBinConfig {
	if in == nil {
		return nil
	}
	out := new(RecycleBinConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *RecycleBinConfig) DeepCopyObject() runtime.Object {
...
func (in *RecycleBinConfigList) DeepCopyInto(out *RecycleBinConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]RecycleBinConfig, len(in.Items))
...
func (in *RecycleBinConfigList) DeepCopy() *RecycleBinConfigList {
	if in == nil {
		return nil
	}
	out := new(RecycleBinConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *RecycleBinConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s RecycleBinConfigStatus) MarshalJSON() ([]byte, error) {
