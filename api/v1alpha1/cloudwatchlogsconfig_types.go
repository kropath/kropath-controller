...
type CloudWatchLogsConfig struct {
	...
	Spec   CloudWatchLogsConfigSpec   `json:"spec,omitempty"`
	Status CloudWatchLogsConfigStatus `json:"status,omitempty"`
}

type CloudWatchLogsConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []CloudWatchLogsConfig `json:"items"`
}

type CloudWatchLogsConfigSpec struct {
	Mandatory cascade.CloudWatchLogsConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.CloudWatchLogsConfigSection `json:"defaults,omitempty"`
}

type CloudWatchLogsConfigStatus struct {
	EffectiveConfig    EffectiveCloudWatchLogsConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveCloudWatchLogsConfig struct {
	...
	Mandatory cascade.EffectiveCloudWatchLogsSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveCloudWatchLogsSection `json:"defaults,omitempty"`
}

func (in *CloudWatchLogsConfig) DeepCopyInto(out *CloudWatchLogsConfig) {
	*out = *in
...
func (in *CloudWatchLogsConfig) DeepCopy() *CloudWatchLogsConfig {
	if in == nil {
		return nil
	}
	out := new(CloudWatchLogsConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudWatchLogsConfig) DeepCopyObject() runtime.Object {
...
func (in *CloudWatchLogsConfigList) DeepCopyInto(out *CloudWatchLogsConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]CloudWatchLogsConfig, len(in.Items))
...
func (in *CloudWatchLogsConfigList) DeepCopy() *CloudWatchLogsConfigList {
	if in == nil {
		return nil
	}
	out := new(CloudWatchLogsConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudWatchLogsConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s CloudWatchLogsConfigStatus) MarshalJSON() ([]byte, error) {
