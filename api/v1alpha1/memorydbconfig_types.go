...
type MemoryDBConfig struct {
	...
	Spec   MemoryDBConfigSpec   `json:"spec,omitempty"`
	Status MemoryDBConfigStatus `json:"status,omitempty"`
}

type MemoryDBConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []MemoryDBConfig `json:"items"`
}

type MemoryDBConfigSpec struct {
	Mandatory cascade.MemoryDBConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.MemoryDBConfigSection `json:"defaults,omitempty"`
}

type MemoryDBConfigStatus struct {
	EffectiveConfig    EffectiveMemoryDBConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveMemoryDBConfig struct {
	...
	Mandatory cascade.EffectiveMemoryDBSection   `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveMemoryDBSection   `json:"defaults,omitempty"`
}

func (in *MemoryDBConfig) DeepCopyInto(out *MemoryDBConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
	if in.Spec.Mandatory.AllowedNodeTypes != nil {
		out.Spec.Mandatory.AllowedNodeTypes = make([]string, len(in.Spec.Mandatory.AllowedNodeTypes))
		copy(out.Spec.Mandatory.AllowedNodeTypes, in.Spec.Mandatory.AllowedNodeTypes)
	}
	...
	if in.Spec.Defaults.AllowedNodeTypes != nil {
		out.Spec.Defaults.AllowedNodeTypes = make([]string, len(in.Spec.Defaults.AllowedNodeTypes))
		copy(out.Spec.Defaults.AllowedNodeTypes, in.Spec.Defaults.AllowedNodeTypes)
	}
	...
	if in.Status.EffectiveConfig.Mandatory.AllowedNodeTypes != nil {
		out.Status.EffectiveConfig.Mandatory.AllowedNodeTypes = make([]string, len(in.Status.EffectiveConfig.Mandatory.AllowedNodeTypes))
		copy(out.Status.EffectiveConfig.Mandatory.AllowedNodeTypes, in.Status.EffectiveConfig.Mandatory.AllowedNodeTypes)
	}
	...
	if in.Status.EffectiveConfig.Defaults.AllowedNodeTypes != nil {
		out.Status.EffectiveConfig.Defaults.AllowedNodeTypes = make([]string, len(in.Status.EffectiveConfig.Defaults.AllowedNodeTypes))
		copy(out.Status.EffectiveConfig.Defaults.AllowedNodeTypes, in.Status.EffectiveConfig.Defaults.AllowedNodeTypes)
	}
...
func (in *MemoryDBConfig) DeepCopy() *MemoryDBConfig {
	if in == nil {
		return nil
	}
	out := new(MemoryDBConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *MemoryDBConfig) DeepCopyObject() runtime.Object {
...
func (in *MemoryDBConfigList) DeepCopyInto(out *MemoryDBConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]MemoryDBConfig, len(in.Items))
...
func (in *MemoryDBConfigList) DeepCopy() *MemoryDBConfigList {
	if in == nil {
		return nil
	}
	out := new(MemoryDBConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *MemoryDBConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s MemoryDBConfigStatus) MarshalJSON() ([]byte, error) {
