...
type SQSConfig struct {
	...
	Spec   SQSConfigSpec   `json:"spec,omitempty"`
	Status SQSConfigStatus `json:"status,omitempty"`
}

type SQSConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []SQSConfig `json:"items"`
}

type SQSConfigSpec struct {
	Mandatory cascade.SQSConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.SQSConfigSection `json:"defaults,omitempty"`
}

type SQSConfigStatus struct {
	EffectiveConfig    EffectiveSQSConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveSQSConfig struct {
	...
	Mandatory cascade.EffectiveSQSSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveSQSSection `json:"defaults,omitempty"`
}
...
func (in *SQSConfig) DeepCopyObject() runtime.Object {
...
func (in *SQSConfigList) DeepCopyInto(out *SQSConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]SQSConfig, len(in.Items))
...
func (in *SQSConfigList) DeepCopy() *SQSConfigList {
	if in == nil {
		return nil
	}
	out := new(SQSConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *SQSConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s SQSConfigStatus) MarshalJSON() ([]byte, error) {
