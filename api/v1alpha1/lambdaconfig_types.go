...
type LambdaConfig struct {
	...
	Spec   LambdaConfigSpec   `json:"spec,omitempty"`
	Status LambdaConfigStatus `json:"status,omitempty"`
}

type LambdaConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []LambdaConfig `json:"items"`
}

type LambdaConfigSpec struct {
	Mandatory cascade.LambdaConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.LambdaConfigSection `json:"defaults,omitempty"`
}

type LambdaConfigStatus struct {
	EffectiveConfig    EffectiveLambdaConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition    `json:"conditions,omitempty"`
	ObservedGeneration int64                 `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                `json:"syncedTimestamp,omitempty"`
}

// EffectiveLambdaConfig is the merged Lambda governance result written to
// LambdaConfig.status.effectiveConfig by the controller. It adds the resolved
...
type EffectiveLambdaConfig struct {
	...
	Mandatory cascade.EffectiveLambdaSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveLambdaSection `json:"defaults,omitempty"`
}
...
func (in *LambdaConfig) DeepCopyObject() runtime.Object {
...
func (in *LambdaConfigList) DeepCopyInto(out *LambdaConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]LambdaConfig, len(in.Items))
...
func (in *LambdaConfigList) DeepCopy() *LambdaConfigList {
	if in == nil {
		return nil
	}
	out := new(LambdaConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *LambdaConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s LambdaConfigStatus) MarshalJSON() ([]byte, error) {
