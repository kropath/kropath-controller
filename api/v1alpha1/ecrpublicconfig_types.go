...
type ECRPublicConfig struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ECRPublicConfigSpec   `json:"spec,omitempty"`
	Status ECRPublicConfigStatus `json:"status,omitempty"`
}

type ECRPublicConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []ECRPublicConfig `json:"items"`
}

type ECRPublicConfigSpec struct {
	Mandatory cascade.ECRPublicConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.ECRPublicConfigSection `json:"defaults,omitempty"`
}

type ECRPublicConfigStatus struct {
	EffectiveConfig    EffectiveECRPublicConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveECRPublicConfig struct {
	...
	Mandatory cascade.EffectiveECRPublicSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveECRPublicSection `json:"defaults,omitempty"`
}

func (in *ECRPublicConfig) DeepCopyInto(out *ECRPublicConfig) {
	*out = *in
...
func (in *ECRPublicConfig) DeepCopy() *ECRPublicConfig {
	if in == nil {
		return nil
	}
	out := new(ECRPublicConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *ECRPublicConfig) DeepCopyObject() runtime.Object {
...
func (in *ECRPublicConfigList) DeepCopyInto(out *ECRPublicConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]ECRPublicConfig, len(in.Items))
...
func (in *ECRPublicConfigList) DeepCopy() *ECRPublicConfigList {
	if in == nil {
		return nil
	}
	out := new(ECRPublicConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *ECRPublicConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s ECRPublicConfigStatus) MarshalJSON() ([]byte, error) {
