...
type CodeArtifactConfig struct {
	...
	Spec   CodeArtifactConfigSpec   `json:"spec,omitempty"`
	Status CodeArtifactConfigStatus `json:"status,omitempty"`
}

type CodeArtifactConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []CodeArtifactConfig `json:"items"`
}

type CodeArtifactConfigSpec struct {
	Mandatory cascade.CodeArtifactConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.CodeArtifactConfigSection `json:"defaults,omitempty"`
}

type CodeArtifactConfigStatus struct {
	EffectiveConfig    EffectiveCodeArtifactConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveCodeArtifactConfig struct {
	...
	Mandatory cascade.EffectiveCodeArtifactSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveCodeArtifactSection `json:"defaults,omitempty"`
}

func (in *CodeArtifactConfig) DeepCopyInto(out *CodeArtifactConfig) {
	*out = *in
...
func (in *CodeArtifactConfig) DeepCopy() *CodeArtifactConfig {
	if in == nil {
		return nil
	}
	out := new(CodeArtifactConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *CodeArtifactConfig) DeepCopyObject() runtime.Object {
...
func (in *CodeArtifactConfigList) DeepCopyInto(out *CodeArtifactConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]CodeArtifactConfig, len(in.Items))
...
func (in *CodeArtifactConfigList) DeepCopy() *CodeArtifactConfigList {
	if in == nil {
		return nil
	}
	out := new(CodeArtifactConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *CodeArtifactConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s CodeArtifactConfigStatus) MarshalJSON() ([]byte, error) {
