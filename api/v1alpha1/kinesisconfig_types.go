...
type KinesisConfig struct {
	...
	Spec   KinesisConfigSpec   `json:"spec,omitempty"`
	Status KinesisConfigStatus `json:"status,omitempty"`
}

type KinesisConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []KinesisConfig `json:"items"`
}

type KinesisConfigSpec struct {
	Mandatory cascade.KinesisConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.KinesisConfigSection `json:"defaults,omitempty"`
}

type KinesisConfigStatus struct {
	EffectiveConfig    EffectiveKinesisConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveKinesisConfig struct {
	...
	Mandatory cascade.EffectiveKinesisSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveKinesisSection `json:"defaults,omitempty"`
}
...
func (in *KinesisConfig) DeepCopyObject() runtime.Object {
...
func (in *KinesisConfigList) DeepCopyInto(out *KinesisConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]KinesisConfig, len(in.Items))
...
func (in *KinesisConfigList) DeepCopy() *KinesisConfigList {
	if in == nil {
		return nil
	}
	out := new(KinesisConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *KinesisConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s KinesisConfigStatus) MarshalJSON() ([]byte, error) {
