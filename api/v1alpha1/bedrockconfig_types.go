...
type BedrockConfig struct {
	...
	Spec   BedrockConfigSpec   `json:"spec,omitempty"`
	Status BedrockConfigStatus `json:"status,omitempty"`
}

type BedrockConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []BedrockConfig `json:"items"`
}

type BedrockConfigSpec struct {
	Mandatory cascade.BedrockConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.BedrockConfigSection `json:"defaults,omitempty"`
}

type BedrockConfigStatus struct {
	EffectiveConfig    EffectiveBedrockConfigStatus `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition           `json:"conditions,omitempty"`
	ObservedGeneration int64                        `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                       `json:"syncedTimestamp,omitempty"`
}

type EffectiveBedrockConfigStatus struct {
	AWS       ProviderIdentity              `json:"aws,omitempty"`
	Mandatory cascade.EffectiveBedrockSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveBedrockSection `json:"defaults,omitempty"`
}
...
func (in *BedrockConfig) DeepCopyInto(out *BedrockConfig) {
	*out = *in
	...
	// Spec.Mandatory
	out.Spec = in.Spec
	if in.Spec.Mandatory.AllowedModels != nil {
		out.Spec.Mandatory.AllowedModels = make([]string, len(in.Spec.Mandatory.AllowedModels))
		copy(out.Spec.Mandatory.AllowedModels, in.Spec.Mandatory.AllowedModels)
	}
	...
	// Spec.Defaults
	if in.Spec.Defaults.AllowedModels != nil {
		out.Spec.Defaults.AllowedModels = make([]string, len(in.Spec.Defaults.AllowedModels))
		copy(out.Spec.Defaults.AllowedModels, in.Spec.Defaults.AllowedModels)
	}
	...
	if in.Status.EffectiveConfig.Mandatory.AllowedModels != nil {
		out.Status.EffectiveConfig.Mandatory.AllowedModels = make([]string, len(in.Status.EffectiveConfig.Mandatory.AllowedModels))
		copy(out.Status.EffectiveConfig.Mandatory.AllowedModels, in.Status.EffectiveConfig.Mandatory.AllowedModels)
	}
	...
	if in.Status.EffectiveConfig.Defaults.AllowedModels != nil {
		out.Status.EffectiveConfig.Defaults.AllowedModels = make([]string, len(in.Status.EffectiveConfig.Defaults.AllowedModels))
		copy(out.Status.EffectiveConfig.Defaults.AllowedModels, in.Status.EffectiveConfig.Defaults.AllowedModels)
	}
...
func (in *BedrockConfig) DeepCopyObject() runtime.Object {
...
func (in *BedrockConfigList) DeepCopyInto(out *BedrockConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]BedrockConfig, len(in.Items))
...
func (in *BedrockConfigList) DeepCopy() *BedrockConfigList {
	if in == nil {
		return nil
	}
	out := new(BedrockConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *BedrockConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s BedrockConfigStatus) MarshalJSON() ([]byte, error) {
