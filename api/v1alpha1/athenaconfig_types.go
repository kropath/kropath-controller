...
type AthenaConfig struct {
	...
	Spec   AthenaConfigSpec   `json:"spec,omitempty"`
	Status AthenaConfigStatus `json:"status,omitempty"`
}

type AthenaConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []AthenaConfig `json:"items"`
}

type AthenaConfigSpec struct {
	Mandatory cascade.AthenaConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.AthenaConfigSection `json:"defaults,omitempty"`
}

type AthenaConfigStatus struct {
	EffectiveConfig    EffectiveAthenaConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition    `json:"conditions,omitempty"`
	ObservedGeneration int64                 `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                `json:"syncedTimestamp,omitempty"`
}

// EffectiveAthenaConfig is the fully merged governance document written by the controller
// into AthenaConfig.status.effectiveConfig.
type EffectiveAthenaConfig struct {
	AWS       ProviderIdentity              `json:"aws,omitempty"`
	Mandatory cascade.EffectiveAthenaSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveAthenaSection `json:"defaults,omitempty"`
}

func (in *AthenaConfig) DeepCopyInto(out *AthenaConfig) {
	*out = *in
...
func (in *AthenaConfig) DeepCopy() *AthenaConfig {
	if in == nil {
		return nil
	}
	out := new(AthenaConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *AthenaConfig) DeepCopyObject() runtime.Object {
...
func (in *AthenaConfigList) DeepCopyInto(out *AthenaConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]AthenaConfig, len(in.Items))
...
func (in *AthenaConfigList) DeepCopy() *AthenaConfigList {
	if in == nil {
		return nil
	}
	out := new(AthenaConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *AthenaConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s AthenaConfigStatus) MarshalJSON() ([]byte, error) {
