...
type EventBridgeConfig struct {
	...
	Spec   EventBridgeConfigSpec   `json:"spec,omitempty"`
	Status EventBridgeConfigStatus `json:"status,omitempty"`
}

type EventBridgeConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []EventBridgeConfig `json:"items"`
}

type EventBridgeConfigSpec struct {
	Mandatory cascade.EventBridgeConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.EventBridgeConfigSection `json:"defaults,omitempty"`
}

type EventBridgeConfigStatus struct {
	EffectiveConfig    EffectiveEventBridgeConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveEventBridgeConfig struct {
	...
	Mandatory cascade.EffectiveEventBridgeSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveEventBridgeSection `json:"defaults,omitempty"`
}
...
func (in *EventBridgeConfig) DeepCopyObject() runtime.Object {
...
func (in *EventBridgeConfigList) DeepCopyInto(out *EventBridgeConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]EventBridgeConfig, len(in.Items))
...
func (in *EventBridgeConfigList) DeepCopy() *EventBridgeConfigList {
	if in == nil {
		return nil
	}
	out := new(EventBridgeConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *EventBridgeConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s EventBridgeConfigStatus) MarshalJSON() ([]byte, error) {
