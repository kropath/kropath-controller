...
type S3AdvancedConfig struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   S3AdvancedConfigSpec   `json:"spec,omitempty"`
	Status S3AdvancedConfigStatus `json:"status,omitempty"`
}

type S3AdvancedConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []S3AdvancedConfig `json:"items"`
}

type S3AdvancedConfigSpec struct {
	Mandatory cascade.S3AdvancedConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.S3AdvancedConfigSection `json:"defaults,omitempty"`
}

type S3AdvancedConfigStatus struct {
	EffectiveConfig    EffectiveS3AdvancedConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition        `json:"conditions,omitempty"`
	ObservedGeneration int64                     `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                    `json:"syncedTimestamp,omitempty"`
}

// EffectiveS3AdvancedConfig is the merged S3 Advanced governance result written to
// S3AdvancedConfig.status.effectiveConfig by the controller. It adds the resolved
...
type EffectiveS3AdvancedConfig struct {
	...
	Mandatory cascade.EffectiveS3AdvancedSection  `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveS3AdvancedSection  `json:"defaults,omitempty"`
}

func (in *S3AdvancedConfig) DeepCopyInto(out *S3AdvancedConfig) {
	*out = *in
...
func (in *S3AdvancedConfig) DeepCopy() *S3AdvancedConfig {
	if in == nil {
		return nil
	}
	out := new(S3AdvancedConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *S3AdvancedConfig) DeepCopyObject() runtime.Object {
...
func (in *S3AdvancedConfigList) DeepCopyInto(out *S3AdvancedConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]S3AdvancedConfig, len(in.Items))
...
func (in *S3AdvancedConfigList) DeepCopy() *S3AdvancedConfigList {
	if in == nil {
		return nil
	}
	out := new(S3AdvancedConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *S3AdvancedConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s S3AdvancedConfigStatus) MarshalJSON() ([]byte, error) {
