...
type NetworkFirewallConfig struct {
	...
	Spec   NetworkFirewallConfigSpec   `json:"spec,omitempty"`
	Status NetworkFirewallConfigStatus `json:"status,omitempty"`
}

type NetworkFirewallConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []NetworkFirewallConfig `json:"items"`
}

type NetworkFirewallConfigSpec struct {
	Mandatory cascade.NetworkFirewallConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.NetworkFirewallConfigSection `json:"defaults,omitempty"`
}

type NetworkFirewallConfigStatus struct {
	EffectiveConfig    EffectiveNetworkFirewallConfig        `json:"effectiveConfig,omitempty"`
...
type EffectiveNetworkFirewallConfig struct {
	...
	Mandatory cascade.EffectiveNetworkFirewallSection   `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveNetworkFirewallSection   `json:"defaults,omitempty"`
}

func (in *NetworkFirewallConfig) DeepCopyInto(out *NetworkFirewallConfig) {
	*out = *in
	...
	// Spec.Mandatory
	out.Spec = in.Spec
	if in.Spec.Mandatory.StatefulDefaultActions != nil {
		out.Spec.Mandatory.StatefulDefaultActions = make([]string, len(in.Spec.Mandatory.StatefulDefaultActions))
		copy(out.Spec.Mandatory.StatefulDefaultActions, in.Spec.Mandatory.StatefulDefaultActions)
	}
	...
	// Spec.Defaults
	if in.Spec.Defaults.StatefulDefaultActions != nil {
		out.Spec.Defaults.StatefulDefaultActions = make([]string, len(in.Spec.Defaults.StatefulDefaultActions))
		copy(out.Spec.Defaults.StatefulDefaultActions, in.Spec.Defaults.StatefulDefaultActions)
	}
	...
	if in.Status.EffectiveConfig.Mandatory.StatefulDefaultActions != nil {
		out.Status.EffectiveConfig.Mandatory.StatefulDefaultActions = make([]string, len(in.Status.EffectiveConfig.Mandatory.StatefulDefaultActions))
		copy(out.Status.EffectiveConfig.Mandatory.StatefulDefaultActions, in.Status.EffectiveConfig.Mandatory.StatefulDefaultActions)
	}
	...
	if in.Status.EffectiveConfig.Defaults.StatefulDefaultActions != nil {
		out.Status.EffectiveConfig.Defaults.StatefulDefaultActions = make([]string, len(in.Status.EffectiveConfig.Defaults.StatefulDefaultActions))
		copy(out.Status.EffectiveConfig.Defaults.StatefulDefaultActions, in.Status.EffectiveConfig.Defaults.StatefulDefaultActions)
	}
...
func (in *NetworkFirewallConfig) DeepCopy() *NetworkFirewallConfig {
	if in == nil {
		return nil
	}
	out := new(NetworkFirewallConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *NetworkFirewallConfig) DeepCopyObject() runtime.Object {
...
func (in *NetworkFirewallConfigList) DeepCopyInto(out *NetworkFirewallConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]NetworkFirewallConfig, len(in.Items))
...
func (in *NetworkFirewallConfigList) DeepCopy() *NetworkFirewallConfigList {
	if in == nil {
		return nil
	}
	out := new(NetworkFirewallConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *NetworkFirewallConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s NetworkFirewallConfigStatus) MarshalJSON() ([]byte, error) {
