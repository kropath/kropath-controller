...
type CloudFrontConfig struct {
	...
	Spec   CloudFrontConfigSpec   `json:"spec,omitempty"`
	Status CloudFrontConfigStatus `json:"status,omitempty"`
}

type CloudFrontConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []CloudFrontConfig `json:"items"`
}

type CloudFrontConfigSpec struct {
	Mandatory cascade.CloudFrontConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.CloudFrontConfigSection `json:"defaults,omitempty"`
}

type CloudFrontConfigStatus struct {
	EffectiveConfig    EffectiveCloudFrontConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition        `json:"conditions,omitempty"`
	ObservedGeneration int64                     `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                    `json:"syncedTimestamp,omitempty"`
}

// EffectiveCloudFrontConfig is the merged CloudFront governance result written to
// CloudFrontConfig.status.effectiveConfig by the controller. It adds the resolved
...
type EffectiveCloudFrontConfig struct {
	...
	Mandatory cascade.EffectiveCloudFrontSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveCloudFrontSection `json:"defaults,omitempty"`
}

func (in *CloudFrontConfig) DeepCopyInto(out *CloudFrontConfig) {
	*out = *in
...
func (in *CloudFrontConfig) DeepCopy() *CloudFrontConfig {
	if in == nil {
		return nil
	}
	out := new(CloudFrontConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudFrontConfig) DeepCopyObject() runtime.Object {
...
func (in *CloudFrontConfigList) DeepCopyInto(out *CloudFrontConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]CloudFrontConfig, len(in.Items))
...
func (in *CloudFrontConfigList) DeepCopy() *CloudFrontConfigList {
	if in == nil {
		return nil
	}
	out := new(CloudFrontConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudFrontConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
