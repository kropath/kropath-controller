...
type CloudWatchConfig struct {
	...
	Spec   CloudWatchConfigSpec   `json:"spec,omitempty"`
	Status CloudWatchConfigStatus `json:"status,omitempty"`
}

type CloudWatchConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []CloudWatchConfig `json:"items"`
}

type CloudWatchConfigSpec struct {
	Mandatory cascade.CloudWatchConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.CloudWatchConfigSection `json:"defaults,omitempty"`
}

type CloudWatchConfigStatus struct {
	EffectiveConfig    EffectiveCloudWatchConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition        `json:"conditions,omitempty"`
	ObservedGeneration int64                     `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                    `json:"syncedTimestamp,omitempty"`
}

// EffectiveCloudWatchConfig is the fully merged governance document written by the controller
// into CloudWatchConfig.status.effectiveConfig.
type EffectiveCloudWatchConfig struct {
	AWS       ProviderIdentity                   `json:"aws,omitempty"`
	Mandatory cascade.EffectiveCloudWatchSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveCloudWatchSection `json:"defaults,omitempty"`
}
...
func (in *CloudWatchConfig) DeepCopyInto(out *CloudWatchConfig) {
	*out = *in
	...
	// Spec.Mandatory
	out.Spec = in.Spec
	if in.Spec.Mandatory.ActionsEnabled != nil {
		v := *in.Spec.Mandatory.ActionsEnabled
		out.Spec.Mandatory.ActionsEnabled = &v
	}
	...
	// Spec.Defaults
	if in.Spec.Defaults.ActionsEnabled != nil {
		v := *in.Spec.Defaults.ActionsEnabled
		out.Spec.Defaults.ActionsEnabled = &v
	}
	...
	if in.Status.EffectiveConfig.Mandatory.ActionsEnabled != nil {
		v := *in.Status.EffectiveConfig.Mandatory.ActionsEnabled
		out.Status.EffectiveConfig.Mandatory.ActionsEnabled = &v
	}
	...
	if in.Status.EffectiveConfig.Defaults.ActionsEnabled != nil {
		v := *in.Status.EffectiveConfig.Defaults.ActionsEnabled
		out.Status.EffectiveConfig.Defaults.ActionsEnabled = &v
	}
...
func (in *CloudWatchConfig) DeepCopyObject() runtime.Object {
...
func (in *CloudWatchConfigList) DeepCopyInto(out *CloudWatchConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]CloudWatchConfig, len(in.Items))
...
func (in *CloudWatchConfigList) DeepCopy() *CloudWatchConfigList {
	if in == nil {
		return nil
	}
	out := new(CloudWatchConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudWatchConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s CloudWatchConfigStatus) MarshalJSON() ([]byte, error) {
