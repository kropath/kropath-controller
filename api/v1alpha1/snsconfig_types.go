...
type SNSConfig struct {
	...
	Spec   SNSConfigSpec   `json:"spec,omitempty"`
	Status SNSConfigStatus `json:"status,omitempty"`
}

type SNSConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []SNSConfig `json:"items"`
}

type SNSConfigSpec struct {
	Mandatory cascade.SNSConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.SNSConfigSection `json:"defaults,omitempty"`
}

type SNSConfigStatus struct {
	EffectiveConfig    EffectiveSNSConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveSNSConfig struct {
	...
	Mandatory cascade.EffectiveSNSSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveSNSSection `json:"defaults,omitempty"`
}

// deepCopyDeliveryFeedbackSection copies a cascade.DeliveryFeedback value (direct struct)
// into dst, allocating new protocol structs for each non-nil protocol pointer.
func deepCopyDeliveryFeedbackSection(src cascade.DeliveryFeedback) cascade.DeliveryFeedback {
	var dst cascade.DeliveryFeedback
...
// deepCopyDeliveryFeedbackPtr copies a *cascade.DeliveryFeedback pointer — used for
// EffectiveSNSSection.DeliveryFeedback which is a pointer so omitempty works correctly.
func deepCopyDeliveryFeedbackPtr(src *cascade.DeliveryFeedback) *cascade.DeliveryFeedback {
	if src == nil {
		return nil
	}
	cp := deepCopyDeliveryFeedbackSection(*src)
	return &cp
}
...
func (in *SNSConfig) DeepCopyInto(out *SNSConfig) {
	*out = *in
	...
	out.Spec.Mandatory.DeliveryFeedback = deepCopyDeliveryFeedbackSection(in.Spec.Mandatory.DeliveryFeedback)
	...
	out.Spec.Defaults.DeliveryFeedback = deepCopyDeliveryFeedbackSection(in.Spec.Defaults.DeliveryFeedback)
	...
	out.Status.EffectiveConfig.Mandatory.DeliveryFeedback = deepCopyDeliveryFeedbackPtr(in.Status.EffectiveConfig.Mandatory.DeliveryFeedback)
	...
	out.Status.EffectiveConfig.Defaults.DeliveryFeedback = deepCopyDeliveryFeedbackPtr(in.Status.EffectiveConfig.Defaults.DeliveryFeedback)
}
...
func (in *SNSConfig) DeepCopyObject() runtime.Object {
...
func (in *SNSConfigList) DeepCopyInto(out *SNSConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]SNSConfig, len(in.Items))
...
func (in *SNSConfigList) DeepCopy() *SNSConfigList {
	if in == nil {
		return nil
	}
	out := new(SNSConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *SNSConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s SNSConfigStatus) MarshalJSON() ([]byte, error) {
