...
type AppScalingConfig struct {
	...
	Spec   AppScalingConfigSpec   `json:"spec,omitempty"`
	Status AppScalingConfigStatus `json:"status,omitempty"`
}

type AppScalingConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []AppScalingConfig `json:"items"`
}

type AppScalingConfigSpec struct {
	Mandatory cascade.AppScalingConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.AppScalingConfigSection `json:"defaults,omitempty"`
}

type AppScalingConfigStatus struct {
	EffectiveConfig    EffectiveAppScalingConfig `json:"effectiveConfig,omitempty"`
...
// result written to AppScalingConfig.status.effectiveConfig by the controller.
// It adds the resolved AWS provider identity on top of the cascade-merged
// Mandatory and Defaults sections.
type EffectiveAppScalingConfig struct {
	AWS       ProviderIdentity                    `json:"aws,omitempty"`
	Mandatory cascade.EffectiveAppScalingSection  `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveAppScalingSection  `json:"defaults,omitempty"`
}

func (in *AppScalingConfig) DeepCopyInto(out *AppScalingConfig) {
	*out = *in
...
func (in *AppScalingConfig) DeepCopy() *AppScalingConfig {
	if in == nil {
		return nil
	}
	out := new(AppScalingConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *AppScalingConfig) DeepCopyObject() runtime.Object {
...
func (in *AppScalingConfigList) DeepCopyInto(out *AppScalingConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]AppScalingConfig, len(in.Items))
...
func (in *AppScalingConfigList) DeepCopy() *AppScalingConfigList {
	if in == nil {
		return nil
	}
	out := new(AppScalingConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *AppScalingConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s AppScalingConfigStatus) MarshalJSON() ([]byte, error) {
