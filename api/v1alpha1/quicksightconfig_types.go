...
type QuickSightConfig struct {
	...
	Spec   QuickSightConfigSpec   `json:"spec,omitempty"`
	Status QuickSightConfigStatus `json:"status,omitempty"`
}

type QuickSightConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []QuickSightConfig `json:"items"`
}

type QuickSightConfigSpec struct {
	Mandatory cascade.QuickSightConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.QuickSightConfigSection `json:"defaults,omitempty"`
}

type QuickSightConfigStatus struct {
	EffectiveConfig    EffectiveQuickSightConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveQuickSightConfig struct {
	...
	Mandatory cascade.EffectiveQuickSightSection  `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveQuickSightSection  `json:"defaults,omitempty"`
}

func (in *QuickSightConfig) DeepCopyInto(out *QuickSightConfig) {
	*out = *in
...
func (in *QuickSightConfig) DeepCopy() *QuickSightConfig {
	if in == nil {
		return nil
	}
	out := new(QuickSightConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *QuickSightConfig) DeepCopyObject() runtime.Object {
...
func (in *QuickSightConfigList) DeepCopyInto(out *QuickSightConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]QuickSightConfig, len(in.Items))
...
func (in *QuickSightConfigList) DeepCopy() *QuickSightConfigList {
	if in == nil {
		return nil
	}
	out := new(QuickSightConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *QuickSightConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s QuickSightConfigStatus) MarshalJSON() ([]byte, error) {
