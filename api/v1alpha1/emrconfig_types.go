...
type EMRConfig struct {
	...
	Spec   EMRConfigSpec   `json:"spec,omitempty"`
	Status EMRConfigStatus `json:"status,omitempty"`
}

type EMRConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []EMRConfig `json:"items"`
}

type EMRConfigSpec struct {
	Mandatory cascade.EMRConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.EMRConfigSection `json:"defaults,omitempty"`
}

type EMRConfigStatus struct {
	EffectiveConfig    EffectiveEMRConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveEMRConfig struct {
	...
	Mandatory cascade.EffectiveEMRSection  `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveEMRSection  `json:"defaults,omitempty"`
}

func (in *EMRConfig) DeepCopyInto(out *EMRConfig) {
	*out = *in
...
func (in *EMRConfig) DeepCopy() *EMRConfig {
	if in == nil {
		return nil
	}
	out := new(EMRConfig)
...
func (in *EMRConfig) DeepCopyObject() runtime.Object {
...
func (in *EMRConfigList) DeepCopyInto(out *EMRConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]EMRConfig, len(in.Items))
...
func (in *EMRConfigList) DeepCopy() *EMRConfigList {
	if in == nil {
		return nil
	}
	out := new(EMRConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *EMRConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s EMRConfigStatus) MarshalJSON() ([]byte, error) {
