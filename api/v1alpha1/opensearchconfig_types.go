...
type OpenSearchConfig struct {
	...
	Spec   OpenSearchConfigSpec   `json:"spec,omitempty"`
...
type OpenSearchConfigSpec struct {
	Mandatory cascade.OpenSearchConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.OpenSearchConfigSection `json:"defaults,omitempty"`
}

type OpenSearchConfigStatus struct {
	EffectiveConfig    EffectiveOpenSearchConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveOpenSearchConfig struct {
	...
	Mandatory cascade.EffectiveOpenSearchSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveOpenSearchSection `json:"defaults,omitempty"`
}
...
func (in *OpenSearchConfigList) DeepCopyInto(out *OpenSearchConfigList) {
	*out = *in
	...
	if in.Items != nil {
		out.Items = make([]OpenSearchConfig, len(in.Items))
...
// (KRO-1199).
func (s OpenSearchConfigStatus) MarshalJSON() ([]byte, error) {
