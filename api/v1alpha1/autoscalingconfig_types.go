...
type AutoScalingConfigSpec struct {
	Mandatory cascade.AutoScalingConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.AutoScalingConfigSection `json:"defaults,omitempty"`
}

type AutoScalingConfigStatus struct {
	EffectiveConfig    EffectiveAutoScalingConfig `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition         `json:"conditions,omitempty"`
	ObservedGeneration int64                      `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                     `json:"syncedTimestamp,omitempty"`
}

// EffectiveAutoScalingConfig is the merged Auto Scaling governance result written to
// AutoScalingConfig.status.effectiveConfig by the controller. It adds the resolved
...
type EffectiveAutoScalingConfig struct {
	...
	Mandatory cascade.EffectiveAutoScalingSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveAutoScalingSection `json:"defaults,omitempty"`
}
...
func (in *AutoScalingConfigList) DeepCopyInto(out *AutoScalingConfigList) {
	*out = *in
	...
	if in.Items != nil {
		out.Items = make([]AutoScalingConfig, len(in.Items))
...
// (KRO-1199).
func (s AutoScalingConfigStatus) MarshalJSON() ([]byte, error) {
