...
type ACMConfig struct {
	...
	Spec   ACMConfigSpec   `json:"spec,omitempty"`
	Status ACMConfigStatus `json:"status,omitempty"`
}

type ACMConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []ACMConfig `json:"items"`
}

type ACMConfigSpec struct {
	Mandatory cascade.ACMConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.ACMConfigSection `json:"defaults,omitempty"`
}

type ACMConfigStatus struct {
	EffectiveConfig    EffectiveACMConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveACMConfig struct {
	...
	Mandatory cascade.EffectiveACMSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveACMSection `json:"defaults,omitempty"`
}

func (in *ACMConfig) DeepCopyInto(out *ACMConfig) {
	*out = *in
...
func (in *ACMConfig) DeepCopy() *ACMConfig {
	if in == nil {
		return nil
	}
	out := new(ACMConfig)
...
func (in *ACMConfig) DeepCopyObject() runtime.Object {
...
func (in *ACMConfigList) DeepCopyInto(out *ACMConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]ACMConfig, len(in.Items))
...
func (in *ACMConfigList) DeepCopy() *ACMConfigList {
	if in == nil {
		return nil
	}
	out := new(ACMConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *ACMConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s ACMConfigStatus) MarshalJSON() ([]byte, error) {
