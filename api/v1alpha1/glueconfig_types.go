...
type GlueConfig struct {
	...
	Spec   GlueConfigSpec   `json:"spec,omitempty"`
	Status GlueConfigStatus `json:"status,omitempty"`
}

type GlueConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []GlueConfig `json:"items"`
}

type GlueConfigSpec struct {
	Mandatory cascade.GlueConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.GlueConfigSection `json:"defaults,omitempty"`
}

type GlueConfigStatus struct {
	EffectiveConfig    EffectiveGlueConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveGlueConfig struct {
	...
	Mandatory cascade.EffectiveGlueSection  `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveGlueSection  `json:"defaults,omitempty"`
}

func (in *GlueConfig) DeepCopyInto(out *GlueConfig) {
	*out = *in
...
func (in *GlueConfig) DeepCopy() *GlueConfig {
	if in == nil {
		return nil
	}
	out := new(GlueConfig)
...
func (in *GlueConfig) DeepCopyObject() runtime.Object {
...
func (in *GlueConfigList) DeepCopyInto(out *GlueConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]GlueConfig, len(in.Items))
...
func (in *GlueConfigList) DeepCopy() *GlueConfigList {
	if in == nil {
		return nil
	}
	out := new(GlueConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *GlueConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
