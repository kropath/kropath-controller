...
type MSKConfig struct {
	...
	Spec   MSKConfigSpec   `json:"spec,omitempty"`
	Status MSKConfigStatus `json:"status,omitempty"`
}

type MSKConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []MSKConfig `json:"items"`
}

type MSKConfigSpec struct {
	Mandatory cascade.MSKConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.MSKConfigSection `json:"defaults,omitempty"`
}

type MSKConfigStatus struct {
	EffectiveConfig    EffectiveMSKConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveMSKConfig struct {
	...
	Mandatory cascade.EffectiveMSKSection   `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveMSKSection   `json:"defaults,omitempty"`
}

func (in *MSKConfig) DeepCopyInto(out *MSKConfig) {
	*out = *in
...
func (in *MSKConfig) DeepCopy() *MSKConfig {
	if in == nil {
		return nil
	}
	out := new(MSKConfig)
...
func (in *MSKConfig) DeepCopyObject() runtime.Object {
...
func (in *MSKConfigList) DeepCopyInto(out *MSKConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]MSKConfig, len(in.Items))
...
func (in *MSKConfigList) DeepCopy() *MSKConfigList {
	if in == nil {
		return nil
	}
	out := new(MSKConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *MSKConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s MSKConfigStatus) MarshalJSON() ([]byte, error) {
