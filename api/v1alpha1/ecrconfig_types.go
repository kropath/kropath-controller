...
type ECRConfig struct {
	...
	Spec   ECRConfigSpec   `json:"spec,omitempty"`
	Status ECRConfigStatus `json:"status,omitempty"`
}

type ECRConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []ECRConfig `json:"items"`
}

type ECRConfigSpec struct {
	Mandatory cascade.ECRConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.ECRConfigSection `json:"defaults,omitempty"`
}

type ECRConfigStatus struct {
	EffectiveConfig    EffectiveECRConfigStatus `json:"effectiveConfig,omitempty"`
	Conditions         []metav1.Condition       `json:"conditions,omitempty"`
	ObservedGeneration int64                    `json:"observedGeneration,omitempty"`
	SyncedTimestamp    string                   `json:"syncedTimestamp,omitempty"`
}

type EffectiveECRConfigStatus struct {
	AWS       ProviderIdentity            `json:"aws,omitempty"`
	Mandatory cascade.EffectiveECRSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveECRSection `json:"defaults,omitempty"`
}
...
func (in *ECRConfig) DeepCopyObject() runtime.Object {
...
func (in *ECRConfigList) DeepCopyInto(out *ECRConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]ECRConfig, len(in.Items))
...
func (in *ECRConfigList) DeepCopy() *ECRConfigList {
	if in == nil {
		return nil
	}
	out := new(ECRConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *ECRConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s ECRConfigStatus) MarshalJSON() ([]byte, error) {
