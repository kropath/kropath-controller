...
type ElastiCacheConfig struct {
	...
	Spec   ElastiCacheConfigSpec   `json:"spec,omitempty"`
	Status ElastiCacheConfigStatus `json:"status,omitempty"`
}

type ElastiCacheConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []ElastiCacheConfig `json:"items"`
}

type ElastiCacheConfigSpec struct {
	Mandatory cascade.ElastiCacheConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.ElastiCacheConfigSection `json:"defaults,omitempty"`
}

type ElastiCacheConfigStatus struct {
	EffectiveConfig    EffectiveElastiCacheConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveElastiCacheConfig struct {
	...
	Mandatory cascade.EffectiveElastiCacheSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveElastiCacheSection `json:"defaults,omitempty"`
}

func (in *ElastiCacheConfig) DeepCopyInto(out *ElastiCacheConfig) {
	*out = *in
...
func (in *ElastiCacheConfig) DeepCopy() *ElastiCacheConfig {
	if in == nil {
		return nil
	}
	out := new(ElastiCacheConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *ElastiCacheConfig) DeepCopyObject() runtime.Object {
...
func (in *ElastiCacheConfigList) DeepCopyInto(out *ElastiCacheConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]ElastiCacheConfig, len(in.Items))
...
func (in *ElastiCacheConfigList) DeepCopy() *ElastiCacheConfigList {
	if in == nil {
		return nil
	}
	out := new(ElastiCacheConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *ElastiCacheConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s ElastiCacheConfigStatus) MarshalJSON() ([]byte, error) {
