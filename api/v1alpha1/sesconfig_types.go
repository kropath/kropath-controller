...
type SESConfig struct {
	...
	Spec   SESConfigSpec   `json:"spec,omitempty"`
	Status SESConfigStatus `json:"status,omitempty"`
}

type SESConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []SESConfig `json:"items"`
}

type SESConfigSpec struct {
	Mandatory cascade.SESConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.SESConfigSection `json:"defaults,omitempty"`
}

type SESConfigStatus struct {
	EffectiveConfig    EffectiveSESConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveSESConfig struct {
	...
	Mandatory cascade.EffectiveSESSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveSESSection `json:"defaults,omitempty"`
}

func (in *SESConfig) DeepCopyInto(out *SESConfig) {
	*out = *in
...
func (in *SESConfig) DeepCopy() *SESConfig {
	if in == nil {
		return nil
	}
	out := new(SESConfig)
...
func (in *SESConfig) DeepCopyObject() runtime.Object {
...
func (in *SESConfigList) DeepCopyInto(out *SESConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]SESConfig, len(in.Items))
...
func (in *SESConfigList) DeepCopy() *SESConfigList {
	if in == nil {
		return nil
	}
	out := new(SESConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *SESConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s SESConfigStatus) MarshalJSON() ([]byte, error) {
