...
type CloudTrailConfig struct {
	...
	Spec   CloudTrailConfigSpec   `json:"spec,omitempty"`
	Status CloudTrailConfigStatus `json:"status,omitempty"`
}

type CloudTrailConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []CloudTrailConfig `json:"items"`
}

type CloudTrailConfigSpec struct {
	Mandatory cascade.CloudTrailConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.CloudTrailConfigSection `json:"defaults,omitempty"`
}

type CloudTrailConfigStatus struct {
	EffectiveConfig    EffectiveCloudTrailConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveCloudTrailConfig struct {
	...
	Mandatory cascade.EffectiveCloudTrailSection   `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveCloudTrailSection   `json:"defaults,omitempty"`
}

func (in *CloudTrailConfig) DeepCopyInto(out *CloudTrailConfig) {
	*out = *in
...
func (in *CloudTrailConfig) DeepCopy() *CloudTrailConfig {
	if in == nil {
		return nil
	}
	out := new(CloudTrailConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudTrailConfig) DeepCopyObject() runtime.Object {
...
func (in *CloudTrailConfigList) DeepCopyInto(out *CloudTrailConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]CloudTrailConfig, len(in.Items))
...
func (in *CloudTrailConfigList) DeepCopy() *CloudTrailConfigList {
	if in == nil {
		return nil
	}
	out := new(CloudTrailConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *CloudTrailConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s CloudTrailConfigStatus) MarshalJSON() ([]byte, error) {
