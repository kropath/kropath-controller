...
type KeyspacesConfig struct {
	...
	Spec   KeyspacesConfigSpec   `json:"spec,omitempty"`
	Status KeyspacesConfigStatus `json:"status,omitempty"`
}

type KeyspacesConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []KeyspacesConfig `json:"items"`
}

type KeyspacesConfigSpec struct {
	Mandatory cascade.KeyspacesConfigSection `json:"mandatory,omitempty"`
	Defaults  cascade.KeyspacesConfigSection `json:"defaults,omitempty"`
}

type KeyspacesConfigStatus struct {
	EffectiveConfig    EffectiveKeyspacesConfig `json:"effectiveConfig,omitempty"`
...
type EffectiveKeyspacesConfig struct {
	...
	Mandatory cascade.EffectiveKeyspacesSection `json:"mandatory,omitempty"`
	Defaults  cascade.EffectiveKeyspacesSection `json:"defaults,omitempty"`
}

func (in *KeyspacesConfig) DeepCopyInto(out *KeyspacesConfig) {
	*out = *in
...
func (in *KeyspacesConfig) DeepCopy() *KeyspacesConfig {
	if in == nil {
		return nil
	}
	out := new(KeyspacesConfig)
	in.DeepCopyInto(out)
	return out
}

func (in *KeyspacesConfig) DeepCopyObject() runtime.Object {
...
func (in *KeyspacesConfigList) DeepCopyInto(out *KeyspacesConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]KeyspacesConfig, len(in.Items))
...
func (in *KeyspacesConfigList) DeepCopy() *KeyspacesConfigList {
	if in == nil {
		return nil
	}
	out := new(KeyspacesConfigList)
	in.DeepCopyInto(out)
	return out
}

func (in *KeyspacesConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// (KRO-1199).
func (s KeyspacesConfigStatus) MarshalJSON() ([]byte, error) {
