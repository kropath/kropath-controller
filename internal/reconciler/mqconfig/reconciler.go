...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.MQConfig) (bool, ctrl.Result, error) {
	...
	globalMQ, err := r.loadMQConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadMQConfig(ctx context.Context, namespace, name string) (*v1alpha1.MQConfig, error) {
	cfg := &v1alpha1.MQConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("MQConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.MQConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
