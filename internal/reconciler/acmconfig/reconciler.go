...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.ACMConfig) (bool, ctrl.Result, error) {
	...
	globalACM, globalACMFound, globalACMViaFallthrough, err := util.LoadConfigWithFallthrough[v1alpha1.ACMConfig](
		ctx, r.Client, v1alpha1.GroupVersion.WithKind("ACMConfig"), globalNS, cfg.Name, util.DefaultConfigProfile)
	if err != nil {
		return false, ctrl.Result{}, err
	}
	...
	profileCond := util.ConfigProfileResolvedCondition(cfg.Name, globalACMFound, globalACMViaFallthrough, cfg.Generation, now)
...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.ACMConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveACMConfig
