...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.CognitoConfig) (bool, ctrl.Result, error) {
	...
	globalCognito, err := r.loadCognitoConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadCognitoConfig(ctx context.Context, namespace, name string) (*v1alpha1.CognitoConfig, error) {
	cfg := &v1alpha1.CognitoConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("CognitoConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.CognitoConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
