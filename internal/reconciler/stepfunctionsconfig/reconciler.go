...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.StepFunctionsConfig) (bool, ctrl.Result, error) {
	...
	globalSFN, globalSFNFound, globalSFNViaFallthrough, err := util.LoadConfigWithFallthrough[v1alpha1.StepFunctionsConfig](
		ctx, r.Client, v1alpha1.GroupVersion.WithKind("StepFunctionsConfig"), globalNS, cfg.Name, util.DefaultConfigProfile)
	if err != nil {
		return false, ctrl.Result{}, err
	}
	...
	profileCond := util.ConfigProfileResolvedCondition(cfg.Name, globalSFNFound, globalSFNViaFallthrough, cfg.Generation, now)
...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.StepFunctionsConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveStepFunctionsConfig
