...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.MSKConfig) (bool, ctrl.Result, error) {
	...
	globalMSK, err := r.loadMSKConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadMSKConfig(ctx context.Context, namespace, name string) (*v1alpha1.MSKConfig, error) {
	cfg := &v1alpha1.MSKConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("MSKConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.MSKConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
