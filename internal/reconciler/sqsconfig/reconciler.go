...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.SQSConfig) (bool, ctrl.Result, error) {
	...
	globalSQS, err := r.loadSQSConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadSQSConfig(ctx context.Context, namespace, name string) (*v1alpha1.SQSConfig, error) {
	cfg := &v1alpha1.SQSConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("SQSConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.SQSConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
