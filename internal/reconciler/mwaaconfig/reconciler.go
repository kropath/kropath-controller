...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.MWAAConfig) (bool, ctrl.Result, error) {
	...
	globalMWAA, err := r.loadMWAAConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadMWAAConfig(ctx context.Context, namespace, name string) (*v1alpha1.MWAAConfig, error) {
	cfg := &v1alpha1.MWAAConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("MWAAConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.MWAAConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
