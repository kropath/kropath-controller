...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.AthenaConfig) (bool, ctrl.Result, error) {
	...
	globalAthena, err := r.loadAthenaConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadAthenaConfig(ctx context.Context, namespace, name string) (*v1alpha1.AthenaConfig, error) {
	cfg := &v1alpha1.AthenaConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("AthenaConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.AthenaConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
