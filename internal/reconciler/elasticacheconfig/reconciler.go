...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.ElastiCacheConfig) (bool, ctrl.Result, error) {
	...
	globalEC, globalECFound, globalECViaFallthrough, err := util.LoadConfigWithFallthrough[v1alpha1.ElastiCacheConfig](
		ctx, r.Client, v1alpha1.GroupVersion.WithKind("ElastiCacheConfig"), globalNS, cfg.Name, util.DefaultConfigProfile)
	if err != nil {
		return false, ctrl.Result{}, err
	}
	...
	profileCond := util.ConfigProfileResolvedCondition(cfg.Name, globalECFound, globalECViaFallthrough, cfg.Generation, now)
...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.ElastiCacheConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveElastiCacheConfig
...
func (r *Reconciler) requestsForKropathConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	if err := r.Client.List(ctx, &list); err != nil {
		r.Log.Error(err, "unable to list ElastiCacheConfig configs for KropathConfig change")
		return nil
	}
...
func (r *Reconciler) requestsForElastiCacheConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	trigger, ok := obj.(*v1alpha1.ElastiCacheConfig)
	if !ok {
		return nil
	}
	...
	var list v1alpha1.ElastiCacheConfigList
	if err := r.Client.List(ctx, &list); err != nil {
		r.Log.Error(err, "unable to list ElastiCacheConfig configs for ElastiCacheConfig change")
		return nil
	}
...
func (r *Reconciler) requestsForNamespaceChange(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	if err := r.Client.List(ctx, &list, client.InNamespace(ns.Name)); err != nil {
		r.Log.Error(err, "unable to list ElastiCacheConfig configs for namespace change", "namespace", ns.Name)
		return nil
	}
