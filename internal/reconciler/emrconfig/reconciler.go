...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.EMRConfig) (bool, ctrl.Result, error) {
	...
	globalEMR, err := r.loadEMRConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadEMRConfig(ctx context.Context, namespace, name string) (*v1alpha1.EMRConfig, error) {
	cfg := &v1alpha1.EMRConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("EMRConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.EMRConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
