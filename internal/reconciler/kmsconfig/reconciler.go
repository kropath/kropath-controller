...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.KMSConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveKMSConfig
