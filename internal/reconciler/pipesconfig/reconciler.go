...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.PipesConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectivePipesConfig
