...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.ELBConfig) (bool, ctrl.Result, error) {
	...
	globalELB, globalELBFound, globalELBViaFallthrough, err := util.LoadConfigWithFallthrough[v1alpha1.ELBConfig](
		ctx, r.Client, v1alpha1.GroupVersion.WithKind("ELBConfig"), globalNS, cfg.Name, util.DefaultConfigProfile)
	if err != nil {
		return false, ctrl.Result{}, err
	}
	...
	profileCond := util.ConfigProfileResolvedCondition(cfg.Name, globalELBFound, globalELBViaFallthrough, cfg.Generation, now)
...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.ELBConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveELBConfig
...
func (r *Reconciler) requestsForKropathConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	if err := r.Client.List(ctx, &list); err != nil {
		r.Log.Error(err, "unable to list ELBConfig configs for KropathConfig change")
		return nil
	}
...
func (r *Reconciler) requestsForELBConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	trigger, ok := obj.(*v1alpha1.ELBConfig)
	if !ok {
		return nil
	}
	...
	var list v1alpha1.ELBConfigList
	if err := r.Client.List(ctx, &list); err != nil {
		r.Log.Error(err, "unable to list ELBConfig configs for ELBConfig change")
		return nil
	}
...
func (r *Reconciler) requestsForNamespaceChange(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	if err := r.Client.List(ctx, &list, client.InNamespace(ns.Name)); err != nil {
		r.Log.Error(err, "unable to list ELBConfig configs for namespace change", "namespace", ns.Name)
		return nil
	}
