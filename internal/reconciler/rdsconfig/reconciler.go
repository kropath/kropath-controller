...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.RDSConfig) (bool, ctrl.Result, error) {
	...
	globalRDS, err := r.loadRDSConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadRDSConfig(ctx context.Context, namespace, name string) (*v1alpha1.RDSConfig, error) {
	cfg := &v1alpha1.RDSConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("RDSConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.RDSConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
