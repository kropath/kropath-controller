...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.OpenSearchConfig) (bool, ctrl.Result, error) {
	...
	globalOS, err := r.loadOpenSearchConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadOpenSearchConfig(ctx context.Context, namespace, name string) (*v1alpha1.OpenSearchConfig, error) {
	cfg := &v1alpha1.OpenSearchConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("OpenSearchConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.OpenSearchConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
