...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.ECSConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveECSConfig
