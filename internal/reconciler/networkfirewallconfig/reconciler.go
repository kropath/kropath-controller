...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.NetworkFirewallConfig) (bool, ctrl.Result, error) {
	...
	globalNFW, err := r.loadNetworkFirewallConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadNetworkFirewallConfig(ctx context.Context, namespace, name string) (*v1alpha1.NetworkFirewallConfig, error) {
	cfg := &v1alpha1.NetworkFirewallConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("NetworkFirewallConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.NetworkFirewallConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
