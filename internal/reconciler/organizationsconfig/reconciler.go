...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.OrganizationsConfig) (bool, ctrl.Result, error) {
	...
	globalOrg, err := r.loadOrganizationsConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadOrganizationsConfig(ctx context.Context, namespace, name string) (*v1alpha1.OrganizationsConfig, error) {
	cfg := &v1alpha1.OrganizationsConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("OrganizationsConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.OrganizationsConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
