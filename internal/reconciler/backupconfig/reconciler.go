...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.BackupConfig) (bool, ctrl.Result, error) {
	...
	globalBackup, err := r.loadBackupConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadBackupConfig(ctx context.Context, namespace, name string) (*v1alpha1.BackupConfig, error) {
	cfg := &v1alpha1.BackupConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("BackupConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.BackupConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
