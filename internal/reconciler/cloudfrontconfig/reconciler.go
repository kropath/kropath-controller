...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.CloudFrontConfig) (bool, ctrl.Result, error) {
	...
	globalCFCfg, err := r.loadCloudFrontConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadCloudFrontConfig(ctx context.Context, namespace, name string) (*v1alpha1.CloudFrontConfig, error) {
	cfg := &v1alpha1.CloudFrontConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("CloudFrontConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.CloudFrontConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
