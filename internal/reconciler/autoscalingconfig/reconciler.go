...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.AutoScalingConfig) (bool, ctrl.Result, error) {
	...
	globalASCfg, globalASCfgFound, globalASCfgViaFallthrough, err := util.LoadConfigWithFallthrough[v1alpha1.AutoScalingConfig](
		ctx, r.Client, v1alpha1.GroupVersion.WithKind("AutoScalingConfig"), globalNS, cfg.Name, util.DefaultConfigProfile)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) withholdEffectiveConfig(cfg *v1alpha1.AutoScalingConfig, reconciledCond metav1.Condition, placementCond *metav1.Condition) bool {
	...
	var zero v1alpha1.EffectiveAutoScalingConfig
...
func (r *Reconciler) requestsForAutoScalingConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	trigger, ok := obj.(*v1alpha1.AutoScalingConfig)
	if !ok {
		return nil
	}
