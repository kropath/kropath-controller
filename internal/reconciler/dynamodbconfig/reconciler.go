...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.DynamoDBConfig) (bool, ctrl.Result, error) {
	...
	globalDDB, err := r.loadDynamoDBConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadDynamoDBConfig(ctx context.Context, namespace, name string) (*v1alpha1.DynamoDBConfig, error) {
	cfg := &v1alpha1.DynamoDBConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("DynamoDBConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.DynamoDBConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
