...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.ApiGatewayV2Config) (bool, ctrl.Result, error) {
	...
	globalApigwv2, err := r.loadApiGatewayV2Config(ctx, kroSystemNamespace, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) requestsForKropathConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	if cfg.Namespace == kroSystemNamespace {
		if err := r.Client.List(ctx, &list); err != nil {
			r.Log.Error(err, "unable to list ApiGatewayV2 configs for global KropathConfig change")
			return nil
		}
	} else {
		if err := r.Client.List(ctx, &list, client.InNamespace(cfg.Namespace)); err != nil {
			r.Log.Error(err, "unable to list ApiGatewayV2 configs for namespace KropathConfig change")
			return nil
		}
	}
...
func (r *Reconciler) requestsForApiGatewayV2ConfigChange(ctx context.Context, obj client.Object) []ctrl.Request {
	cfg, ok := obj.(*v1alpha1.ApiGatewayV2Config)
	...
	var list v1alpha1.ApiGatewayV2ConfigList
	if err := r.Client.List(ctx, &list); err != nil {
		r.Log.Error(err, "unable to list ApiGatewayV2 configs for global ApiGatewayV2Config change")
		return nil
	}
