...
func (r *Reconciler) reconcile(ctx context.Context, cfg *v1alpha1.KeyspacesConfig) (bool, ctrl.Result, error) {
	...
	globalKeyspaces, err := r.loadKeyspacesConfig(ctx, globalNS, cfg.Name)
	if err != nil {
		return false, ctrl.Result{}, err
	}
...
func (r *Reconciler) loadKeyspacesConfig(ctx context.Context, namespace, name string) (*v1alpha1.KeyspacesConfig, error) {
	cfg := &v1alpha1.KeyspacesConfig{}
	cfg.SetGroupVersionKind(v1alpha1.GroupVersion.WithKind("KeyspacesConfig"))
	if err := r.Client.Get(ctx, types.NamespacedName{Namespace: namespace, Name: name}, cfg); err != nil {
		if client.IgnoreNotFound(err) == nil {
			return &v1alpha1.KeyspacesConfig{}, nil
		}
		return nil, err
	}
	return cfg, nil
